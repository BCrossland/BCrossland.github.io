...
!function(t) {
            ...
            if (null != h) {
                ...
                if (E.length)
                    for (var g = 0; g <= E.length; g++) {
                        ...
                        if (!t || void 0 === r[m]) {
                            var _ = h[m];
                            e && f(r[m]) && f(_) && (_ = s(t, e, r[m], _)),
                            void 0 !== _ && _ !== r[m] && (u || (u = !0, r = c(r)), r[m] = _)
                        }
                    }
            }
        }
    ...
    t.exports = function(t, e, n, c, s, f) {
        ...
        for (f.set(t, e), f.set(e, t); ++E < d;) {
            var _ = t[E],
                y = e[E];
            if (c)
                var I = l ? c(y, _, E, e, t, f) : c(_, y, E, t, e, f);
            if (void 0 !== I) {
                if (I)
                    continue;
                g = !1;
    ...
    t.exports = function(t, e, n, E, g, m) {
        ...
        if (O && !T)
            return m || (m = new r), _ || f(t) ? i(t, e, n, E, g, m) : o(t, e, I, n, E, g, m);
        if (!(n & l)) {
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (var g = s; ++d < l;) {
            var m = t[p = f[d]],
                _ = e[p];
            if (a)
                var y = s ? a(_, m, p, e, t, c) : a(m, _, p, t, e, c);
    ...
    e.getInstanceOrigin = function(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            o = r.actionTypeId,
            a = r.config;
        if ((0, g.isPluginType)(o))
            return (0, g.getPluginOrigin)(o)(e[o]);
        switch (o) {
        case Z:
        case J:
        case tt:
    ...
    e.renderHTMLElement = function(t, e, n, r, i, o, a, u, c) {
            ...
            return function(t, e, n, r, i, o) {
                ...
                case it:
                    var s = r.config,
                        ...
                        h = n.widthValue,
                        E = n.heightValue;
                    void 0 !== h && (d === B && (d = "px"), Rt(t, L, o), a(t, L, h + d)),
                    void 0 !== E && (v === B && (v = "px"), Rt(t, P, o), a(t, P, E + v));
                    break;
                case rt:
                    !function(t, e, n, r) {
                ...
                case ut:
                    var g = lt[u],
                        ...
                        I = n.aValue;
                    Rt(t, g, o),
                    a(t, g, I >= 1 ? "rgb(".concat(m, ",").concat(_, ",").concat(y, ")") : "rgba(".concat(m, ",").concat(_, ",").concat(y, ",").concat(I, ")"));
                    break;
                default:
                    var b = c.unit,
                        T = void 0 === b ? "" : b;
        ...
        case q:
            ...
            if ((0, g.isPluginType)(s))
                return (0, g.renderPlugin)(s)(c, e, i)
        }
    },
    ...
    e.getItemConfigByKey = function(t, e, n) {
        if ((0, g.isPluginType)(t))
            return (0, g.getPluginConfig)(t)(n, e);
        switch (t) {
        case rt:
    ...
    t.exports = function(t, e, n) {
        ...
        function T() {
            ...
            if (s = arguments, f = this, v = t, n) {
                ...
                if (g)
                    return clearTimeout(p), p = setTimeout(I, e), _(v)
            }
        ...
        function y(e, n) {
            ...
            i.fileUploads.each(function(e) {
                !function(e, n) {
                    ...
                    }), l.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), g)
                    ...
                    function w(t) {
                        var r = t.responseJSON && t.responseJSON.msg,
                            i = y;
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = _ : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = m),
                        p.text(i),
                        f.removeAttr("data-value"),
                        f.val(""),
                        a.toggle(!1),
            ...
            m.test(s) ? i.handler = A : s || (o ? i.handler = O : _())
        }
        function I(t) {
    ...
    function f(t, e, n, r) {
        var o,
            ...
            g = [];
        function m(t, e) {
            return E = p(t) ? t : [t], f || m.build(), function(t) {
                ...
                s(r, "show item ".concat(e + 1, " of ").concat(E.length)),
                a(t) && r.addClass(i),
            ...
            if (t !== o) {
                ...
                return o = t, f.spinner.attr("aria-hidden", !1).attr("aria-busy", !0).attr("aria-valuenow", 0).attr("aria-valuetext", "Loading image"), l.show(), N(e.html && (s = e.width, p = e.height, "data:image/svg+xml;charset=utf-8," + encodeURI('<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + p + '"/>')) || e.url, function(r) {
                    if (t === o) {
                        ...
                        e.html && ((a = (i = n(e.html)).is("iframe")) && i.on("load", g), s.append(D(i, "embed"))),
        ...
        var y = _(m.prev),
            ...
            w = function(t, e) {
                t.preventDefault(),
                "left" === e.direction ? m.next() : "right" === e.direction && m.prev()
            },
            O = function() {
                this.focus()
            };
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "8c6a0005-c0cb-30b4-f637-13aaca409e61"
                        },
                        "value": "block"
                    }
                }]
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "626a4949d59ab531f57acb25|8c6a0005-c0cb-30b4-f637-13aaca409e61"
                        },
                        "value": "block"
                    }
                }]
